...
switch nth
    ...
    case 1
        for n = nth:size(raw,1)

        filtered(n,1) = b0(1)* raw(n,1)  ...                
                      - a0(1)*filtered(n,1) ;
        end
    case 2
        for n = nth:size(raw,1)
        ...
        filtered(n,1) = b0(1)* raw(n,1)   + b0(2)* raw(n-1,1) ...                
                      - a0(1)*filtered(n,1)   - a0(2)*filtered(n-1,1);
        end
    ...
    case 3
        ...
        filtered(n,1) = b0(1)* raw(n,1)   + b0(2)* raw(n-1,1) + b0(3)* raw(n-2,1) ...                
                      - a0(1)*filtered(n,1)   - a0(2)*filtered(n-1,1) - a0(3)*filtered(n-2,1) ;
        end
    ...
    case 4
        ...
        filtered(n,1) = b0(1)* raw(n,1)   + b0(2)* raw(n-1,1) + b0(3)* raw(n-2,1)+b0(4)* raw(n-3,1) ...                
                      - a0(1)*filtered(n,1)   - a0(2)*filtered(n-1,1) - a0(3)*filtered(n-2,1)- a0(4)*filtered(n-3,1) ;
        end
    ...
    case 5
        ...
        filtered(n,1) = b0(1)* raw(n,1)   + b0(2)* raw(n-1,1) + b0(3)* raw(n-2,1)+ b0(4)* raw(n-3,1) + b0(5)* raw(n-4,1) ...                
                      - a0(1)*filtered(n,1)   - a0(2)*filtered(n-1,1) - a0(3)*filtered(n-2,1)- a0(4)*filtered(n-3,1) - a0(5)*filtered(n-4,1) ;
        end
    
    case 6
        for n = nth:size(raw,1)
        filtered(n,1) = b0(1)* raw(n,1)   + b0(2)* raw(n-1,1) + b0(3)* raw(n-2,1)+ b0(4)* raw(n-3,1) + b0(5)* raw(n-4,1)++ b0(6)* raw(n-5,1) ...                
                      - a0(1)*filtered(n,1)   - a0(2)*filtered(n-1,1) - a0(3)*filtered(n-2,1)- a0(4)*filtered(n-3,1) - a0(5)*filtered(n-4,1)- a0(6)*filtered(n-5,1) ;
        end
end
